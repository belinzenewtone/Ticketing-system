        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground tracking-tight">Email Dashboard</h1>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Track and resolve employee email issues</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {statCards.map((c) => (
                    <div key={c.label} className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-5">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">{c.label}</p>
                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-5">
                        ...
                        <div className="flex items-end gap-3 mb-4">
                            ...
                            <span className="text-slate-400 text-sm pb-1">{stats?.sorted ?? 0} of {stats?.total ?? 0} resolved</span>
                        </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-5">
                        <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Status Breakdown</p>
                        {resolutionBreakdown.length === 0 ? (
                            <p className="text-slate-400 text-center py-8 text-sm">No entries yet</p>
                        ) : (
                                    ...
                                    return (
                                        <div key={key} className="space-y-1.5">
                                            <div className="flex justify-between text-sm">
                                                <span className="font-semibold text-foreground">{config?.label.replace('✅', '').trim() || key}</span>
            ...
            <Dialog open={formOpen} onOpenChange={setFormOpen}>
                <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden gap-0">
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-700 px-6 py-5">
                        <DialogTitle className="text-white text-lg font-bold">{editingId ? 'Edit Entry' : 'New Email Entry'}</DialogTitle>
